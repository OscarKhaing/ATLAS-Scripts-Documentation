...
### `[-t]`
```
-t [control file template]: (optional). Specifies the type of input file to create. See list:
in.lammps.2pt         in.lammps.cnt_h2o    in.lammps.md             in.lammps.pre_fep                  in.lammps.solv.rigidSolu
in.lammps.2pt_f3c     in.lammps.cof        in.lammps.melt           in.lammps.pressureflow             in.lammps.solvation
in.lammps.2pt_tip4    in.lammps.compress   in.lammps.mesodna        in.lammps.prod                     in.lammps.solvation_f3c
in.lammps.anneal      in.lammps.electrode  in.lammps.min            in.lammps.pulse                    in.lammps.test
in.lammps.atom.eng    in.lammps.entropy    in.lammps.mof            in.lammps.reaxff                   in.lammps.thermal_conductivity
in.lammps.battery     in.lammps.equil      in.lammps.nano110        in.lammps.rimse                    in.lammps.thz-pulse
in.lammps.biogroup    in.lammps.equil_new  in.lammps.nano_indent_x  in.lammps.rimse_solvent            in.lammps.viscosity
in.lammps.bulk        in.lammps.fep        in.lammps.nano_indent_y  in.lammps.solv                     in.lammps.water
in.lammps.carbonates  in.lammps.full       in.lammps.np_couple      in.lammps.solv.2pt
in.lammps.ced         in.lammps.gpcr       in.lammps.npt            in.lammps.solv.2pt.rigidSolu
in.lammps.cnt         in.lammps.heat       in.lammps.nve            in.lammps.solv.atom.eng
in.lammps.cntWat      in.lammps.ift        in.lammps.polymer        in.lammps.solv.atom.eng.rigidSolu
```
